...
final class ShortcutCaptureSession {
    ...
    func start(action: HotKeyAction, hotKeys: HotKeyBindings) {
        stop()
    ...
    private func updateEscapeProbe(
        flags: NSEvent.ModifierFlags, action: HotKeyAction, hotKeys: HotKeyBindings?
    ) {
    ...
    private func handleKeyDown(
        ...
        action: HotKeyAction, hotKeys: HotKeyBindings
    ) {
    ...
    private func commitCombo(
        keyCode: Int, flags: NSEvent.ModifierFlags, action: HotKeyAction, hotKeys: HotKeyBindings
    ) {
    ...
    private func commit(_ binding: HotKeyBinding, action: HotKeyAction, hotKeys: HotKeyBindings) {
