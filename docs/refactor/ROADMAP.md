...
| 04  | Complete    | `refactor/04-retire-the-last-nsalert`      | 2026-08-05 | Consent prompt converted in phase 04; the missed snippet argument alert was retired by the final architecture follow-up, so `Tinycast/` now has no `NSAlert` or nested dialog run loop. |
...
| 22  | Complete    | shared working tree                        | 2026-09-01 | Clipboard and Calculator History moved to `PaletteScreen`; calculator cards are rows. |
| 23  | Complete    | shared working tree                        | 2026-09-01 | Launcher moved to `PaletteScreen`; selection uses one row layout including AI and function rows. |
| 24  | Complete    | shared working tree                        | 2026-09-01 | Quicklink and snippet orchestration extracted into coordinators. |
| 25  | Complete    | shared working tree                        | 2026-09-01 | Palette, system action, uninstall and custom-command coordinators extracted. |
| 26  | Complete    | shared working tree                        | 2026-09-01 | Core inversions removed; BackupCoordinator added for the uncovered backup flow. |
| 27  | Complete    | shared working tree                        | 2026-09-01 | DesignSystem and Platform trees extracted; off-limits files stayed byte-identical. |
| 28  | Complete    | shared working tree                        | 2026-09-01 | Windows, Palette and App composition-root trees extracted. |
| 29  | Complete    | shared working tree                        | 2026-09-01 | Feature-first tree completed and `Tinycast/Core/` deleted. |
| 30  | Complete    | shared working tree                        | 2026-09-01 | Naming vocabulary applied without changing persisted identifiers. |
| 31  | Complete    | shared working tree                        | 2026-09-01 | `AppEntry.Kind` metadata centralized and switches made exhaustive. |
| 32  | Complete    | shared working tree                        | 2026-09-01 | AppCore coordinator forwarders removed; singleton access reduced to app entry points. |
| 33  | Complete    | shared working tree                        | 2026-09-01 | Settings backup completeness harness added with explicit consent exclusion. |
| 34  | Complete    | shared working tree                  | 2026-09-01 | Comment budget and all 19 automated harnesses pass. User accepted the pre-existing 4.94 MB MarkdownUI-dominated binary overage and waived unavailable manual UI/pixel/Instruments/RSS gates. |
| 35  | Complete    | shared working tree                  | 2026-09-01 | Compatibility cleanup and final architecture follow-ups complete; all confirmations use the app-owned async dialog, automated gates and independent review pass. |
